  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex w-full items-center gap-2 justify-between text-left text-gray-500 px-3 py-2 rounded-sm border-1 border-gray-200 focus:border-white focus:ring-2 focus:ring-[#ffc596]"
      >
        {value
